<x-dashboard-layout.minimal title="Success" route="edit-success" event_id="{{$event}}">
  ...
  <div class="w-full lg:w-3/5 mx-auto xl:px-12 text-center">
    ...
    @else
      <h1 class="font-bold text-lg lg:text-3xl text-primary-500 lg:mt-4 mb-5 lg:mb-8">Evento atualizado!</h1>
      <img src="{{ asset('/img/auth-img.png') }}" alt="Party" class="w-64 max-w-xs mx-auto mb-3">
      ...
      <div class="pb-16 pt-6">
        <a href="/events/{{$event}}" class="inline-flex items-center justify-center bg-white border border-danger-500 rounded-lg mr-4 w-auto px-6 h-10 lg:h-12 text-sm font-bold text-danger-500 hover:bg-opacity-90">Voltar ao Evento</a>
